...
class StudioTypeController extends Controller
{
    ...
    public function apiIndex(Request $request)
    {
        ...
        return response()->json($studioTypes);
    }
        ...
        if ($request->ajax()) {
            ...
            return DataTables::of($data)
                ...
                ->addColumn('action', function ($row) {
                    ...
                    $btn .= '<form action="'.$deleteUrl.'" method="POST" class="inline-block" onsubmit="confirmDelete(event, \''.__('Are you sure you want to delete this studio type?').'\');">
                                '.csrf_field().'
                                '.method_field('DELETE').'
