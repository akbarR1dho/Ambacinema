...
@section('content')
<div class="mb-6">
    <h2 class="text-2xl font-bold text-slate-900 mb-2">Edit Studio: {{ $studio->name }}</h2>
...
<div class="bg-white border border-slate-200 rounded-xl p-6 shadow-sm max-w-2xl">
    <form action="{{ route('admin.studios.update', $studio->id) }}" method="POST">
        ...
        <div class="mb-6">
            ...
            <p class="text-xs text-red-500 mt-1">Seat count cannot be modified after creation.</p>
        </div>
