    ...
    <div class="bg-white border border-slate-200 rounded-xl p-6 shadow-sm">
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-3xl font-bold text-slate-900 mt-1">{{ $total['studio'] }}</p>
            </div>
    ...
    <div class="bg-white border border-slate-200 rounded-xl p-6 shadow-sm">
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-3xl font-bold text-slate-900 mt-1">{{ $total['movie'] }}</p>
            </div>
            <div class="p-3 bg-blue-100 rounded-lg text-blue-600">
    ...
    <div class="bg-white border border-slate-200 rounded-xl p-6 shadow-sm">
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-3xl font-bold text-slate-900 mt-1">{{ $total['showtime'] }}</p>
            </div>
            <div class="p-3 bg-blue-100 rounded-lg text-blue-600">
    ...
    <div class="bg-white border border-slate-200 rounded-xl p-6 shadow-sm">
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-3xl font-bold text-slate-900 mt-1">{{ $total['order'] }}</p>
            </div>
            <div class="p-3 bg-blue-100 rounded-lg text-blue-600">
